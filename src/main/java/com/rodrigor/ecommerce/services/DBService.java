...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Categoria cat8 = new Categoria(null, "Perfumaria MOD");
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "fenixgame.rodrigor@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, encrypt.encode("123"));
		Cliente cli2 = new Cliente(null, "Ana Silva", "fenixgame@gmail.com", "39199838079", TipoCliente.PESSOAFISICA, encrypt.encode("123"));
		cli2.addPerfilUsuario(PerfilUsuario.ADMIN);
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		cli2.getTelefones().addAll(Arrays.asList("4234234234", "242342423"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Joaquim Ribeiro", "800", "Bloco B", "Centro", "38777012", cli2, c2);
